...
class TestUsdUINodeGraphNode(unittest.TestCase):
    def test_Basic(self):
        ...
        assert (
            posAttr.GetTypeName() == 'float2'
        ), f"Type of position attribute should be 'float2', not {posAttr.GetTypeName()}"
        ...
        assert (
            stackingOrderAttr.GetTypeName() == 'int'
        ), f"Type of position attribute should be 'int', not {stackingOrderAttr.GetTypeName()}"
        ...
        assert (
            displayColorAttr.GetTypeName() == 'color3f'
        ), f"Type of position attribute should be 'color3f', not {displayColorAttr.GetTypeName()}"
        ...
        assert (
            sizeAttr.GetTypeName() == 'float2'
        ), f"Type of size attribute should be 'float2', not {sizeAttr.GetTypeName()}"
