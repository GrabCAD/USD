...
class TestUsdUISceneGraphPrim(unittest.TestCase):
    def test_Basic(self):
        ...
        assert (
            displayNameAttr.GetTypeName() == 'token'
        ), f"Type of position attribute should be 'token', not {displayNameAttr.GetTypeName()}"
        ...
        assert (
            displayGroupAttr.GetTypeName() == 'token'
        ), f"Type of position attribute should be 'token', not {displayGroupAttr.GetTypeName()}"
